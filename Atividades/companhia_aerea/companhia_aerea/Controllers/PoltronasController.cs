...
namespace companhia_aerea.Controllers
{
    public class PoltronasController : Controller
    {
        ...
        public PoltronasController(CompanhiaAereaContext context)
        {
            _context = context;
        }
        ...
        {
            var companhiaAereaContext = _context.Poltronas.Include(p => p.IdAeronaveNavigation);
        ...
        public async Task<IActionResult> Create([Bind("Id,IdAeronave,Disponivel,Localizacao")] Poltrona poltrona)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,IdAeronave,Disponivel,Localizacao")] Poltrona poltrona)
        {
            if (id != poltrona.Id)
            {
                return NotFound();
